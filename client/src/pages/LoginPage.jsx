      ...
      <div className="hidden lg:flex lg:w-7/12 relative overflow-hidden items-end p-16">
        ...
        >
          ...
          <p className="text-gray-500 font-light text-base leading-relaxed">
            Access millions of refined parameters to generate the highest definition visuals in existence.
          </p>
        </motion.div>
      </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-1.5">
                <label className="text-[11px] font-semibold tracking-wider text-gray-500 uppercase">Identity</label>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between">
                  <label className="text-[11px] font-semibold tracking-wider text-gray-500 uppercase">Passcode</label>
                  <a href="#" className="text-[11px] text-gray-600 hover:text-gray-400">Reset</a>
                </div>
                <div className="relative">
                  <input
